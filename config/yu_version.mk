...
# Set all versions
YU_VERSION := YUOS-$(PRODUCT_VERSION_MAJOR)-$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(YU_BUILD_TYPE)$(YU_POSTFIX)
YU_MOD_VERSION := YUOS-$(PRODUCT_VERSION_MAJOR)-$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(YU_BUILD_TYPE)$(YU_POSTFIX)-$(YU_BUILD)
